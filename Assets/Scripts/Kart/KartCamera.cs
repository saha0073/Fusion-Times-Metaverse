...
public class KartCamera : KartComponent, ICameraController
{
	...
	public override void OnLapCompleted(int lap, bool isFinish)
	{
		...
		Debug.Log("OnLapCompleted() in KartCamera");
	}
	...
	public override void Render()
	{
		...
		{
			Debug.Log("Render() in KartCamera.cs");
	...
	{
		//Debug.Log("ControlCameraDriving() in KartCamera.cs");
	...
	{
		//Debug.Log("SetFOV() in KartCamera.cs");
	...
	{
		//Debug.Log("GetViewpoint() in KartCamera.cs");
